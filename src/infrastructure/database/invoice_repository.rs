...
impl super::InvoiceRepository for SqliteInvoiceRepository {
    ...
    async fn find_by_id(&self, _tenant_id: &str, _invoice_id: &str) -> Result<Option<crate::domain::invoice::InvoiceData>> {
    ...
    async fn find_by_number(&self, _tenant_id: &str, _invoice_number: &str) -> Result<Option<crate::domain::invoice::InvoiceData>> {
    ...
    async fn list_overdue(&self, _tenant_id: &str) -> Result<Vec<crate::domain::invoice::InvoiceData>> {
